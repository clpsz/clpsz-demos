...
(
    ...
    `saga_id` BIGINT UNSIGNED NOT NULL COMMENT 'saga_id, reference to table:saga_table#saga_id',
...
-- BEGIN;
-- INSERT INTO order_table (item_id, saga_id, item_count, payed_amount, order_status, create_time, update_time) values (1, 1, 1, 99, 'INIT', 1645604905025, 1645604905025);
-- COMMIT;
