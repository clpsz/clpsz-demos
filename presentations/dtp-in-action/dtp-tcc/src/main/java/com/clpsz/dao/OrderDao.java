...
public class OrderDao {
    ...
    public Order selectByTccIdForUpdate(Connection conn, Long tccId) throws SQLException {
        Statement stmt = conn.createStatement();

        String sql = String.format("select * from order_table where tcc_id=%d for update", tccId);
